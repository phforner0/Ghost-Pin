...
class ScheduleReceiverInstrumentedTest {
    ...
    fun onReceive_startEventForwardsFullScheduleConfigToService() {
        ...
        val schedule = ScheduleEntity(
            ...
            waypointsJson = com.ghostpin.app.data.SimulationConfig.serializeWaypoints(
                listOf(
                    com.ghostpin.core.model.Waypoint(-23.0, -46.0),
                    com.ghostpin.core.model.Waypoint(-22.5, -44.0),
                    com.ghostpin.core.model.Waypoint(-22.0, -43.0),
                )
            ),
        ...
        val receiver = ScheduleReceiver().apply {
        ...
        assertEquals(schedule.waypointPauseSec, startedIntent.getDoubleExtra(SimulationService.EXTRA_WAYPOINT_PAUSE_SEC, 0.0), 0.0)
        ...
        assertArrayEquals(doubleArrayOf(-23.0, -22.5, -22.0), startedIntent.getDoubleArrayExtra(SimulationService.EXTRA_WAYPOINTS_LAT), 0.0)
        assertArrayEquals(doubleArrayOf(-46.0, -44.0, -43.0), startedIntent.getDoubleArrayExtra(SimulationService.EXTRA_WAYPOINTS_LNG), 0.0)
    }
    ...
    private class FakeScheduleDao(
        ...
        override suspend fun getById(scheduleId: String): ScheduleEntity? = if (schedule.id == scheduleId) schedule else null
