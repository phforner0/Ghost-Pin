...
class ProfileManager @Inject constructor(
    ...
    companion object {
        ...
        private val BUILT_IN_PROFILES: List<Pair<String, MovementProfile>> = listOf(
    ...
    suspend fun seedBuiltInsIfNeeded() {
        val entities = BUILT_IN_PROFILES.map { (id, profile) ->
    ...
    suspend fun getById(id: String): MovementProfile? =
        dao.getById(id)?.toDomain()

    /** Get a profile entity by ID (includes metadata like version and isBuiltIn). */
    suspend fun getEntityById(id: String): ProfileEntity? =
        dao.getById(id)
     ...
     */
    suspend fun create(profile: MovementProfile, name: String = profile.name): String {
        val id = UUID.randomUUID().toString()
        val entity = ProfileEntity.fromDomain(
     ...
     */
    suspend fun update(id: String, updated: MovementProfile) {
