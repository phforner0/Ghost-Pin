...
class RouteFileParser
    ...
    constructor() {
        companion object {
            ...
            fun detectFormat(content: String): RouteFormat? =
                when {
