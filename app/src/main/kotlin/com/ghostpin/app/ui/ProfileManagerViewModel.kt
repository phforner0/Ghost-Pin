...
class ProfileManagerViewModel @Inject constructor(
    ...
    val profiles: StateFlow<List<ProfileEntity>> = profileManager
        .observeAllEntities()
     ...
     */
    fun clone(sourceId: String, newName: String, onResult: (String?) -> Unit = {}) {
     ...
     */
    fun update(id: String, updated: MovementProfile, onError: (String) -> Unit = {}) {
        viewModelScope.launch {
